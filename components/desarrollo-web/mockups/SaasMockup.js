    ...
    <div className="w-full bg-[#0D0E12] text-[#ECEEF2] font-sans select-none overflow-x-hidden min-h-full flex flex-col justify-between border border-white/10 p-6 md:p-10">
      ...
      <header className="px-4 py-3 bg-[#12141B] border border-white/10 rounded-2xl flex items-center justify-between font-mono text-xs mb-4">
        <div className="flex items-center gap-3">
          <div className="w-7 h-7 rounded-lg bg-[#5C9E43] flex items-center justify-center text-black font-black text-xs">
            ⚡
          </div>
          <span className="font-bold text-white tracking-tight">LINEAR_FLOW.IO</span>
          <span className="bg-[#5C9E43]/20 text-[#5C9E43] px-2 py-0.5 rounded text-[10px] font-bold border border-[#5C9E43]/30 hidden sm:inline">
            PROD v2.4
          </span>
        </div>
        ...
        <button className="bg-[#5C9E43] text-black font-bold px-4 py-1.5 rounded-lg hover:bg-emerald-400 transition-colors text-xs flex items-center gap-1.5 shadow-[0_0_15px_rgba(92,158,49,0.3)]">
      ...
      <div className="my-auto space-y-6 py-4">
        <div className="inline-flex items-center gap-2 bg-[#5C9E43]/10 text-[#5C9E43] px-3.5 py-1.5 rounded-full font-mono text-xs font-bold border border-[#5C9E43]/20">
        ...
        <h2 className="text-3xl sm:text-5xl md:text-6xl font-black text-white leading-tight tracking-tight">
          Minimalist SaaS <br />
          <span className="text-[#5C9E43]">Raycast & Linear Aesthetic.</span>
        </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 font-mono text-xs pt-2">
          <div className="bg-[#16181D] p-3.5 rounded-xl border border-white/10 space-y-1">
            <div className="flex justify-between items-center text-neutral-400 text-[10px]">
              ...
              <Activity size={14} className="text-[#5C9E43]" />
            </div>
          ...
          <div className="bg-[#16181D] p-3.5 rounded-xl border border-white/10 space-y-1">
            <div className="flex justify-between items-center text-neutral-400 text-[10px]">
              ...
              <Zap size={14} className="text-[#5C9E43]" />
            </div>
            <div className="text-xl font-black text-[#5C9E43]">99 / 100</div>
          ...
          <div className="bg-[#16181D] p-3.5 rounded-xl border border-white/10 space-y-1">
            <div className="flex justify-between items-center text-neutral-400 text-[10px]">
              ...
              <Server size={14} className="text-[#5C9E43]" />
            </div>
          ...
          <div className="bg-[#16181D] p-3.5 rounded-xl border border-white/10 space-y-1">
            <div className="flex justify-between items-center text-neutral-400 text-[10px]">
              <span>SEGURIDAD</span>
              <CheckCircle2 size={14} className="text-[#5C9E43]" />
            </div>
      ...
      <footer className="border-t border-white/10 pt-3 font-mono text-xs text-neutral-400 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-[#5C9E43]" />
