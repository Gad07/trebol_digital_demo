      ...
      <section className="relative w-full min-h-screen min-h-[100dvh] pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 px-5 sm:px-8 md:px-12 bg-hueso overflow-hidden border-b border-carbon/10 flex items-center">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          <Image
            ...
            alt="Desarrollo Organizacional Trébol Digital"
            fill
            priority
        ...
        <div className="max-w-[1350px] mx-auto relative z-10 w-full">
          ...
          <div className="max-w-3xl space-y-6 text-left">
            ...
            >
              Diseñamos la arquitectura organizacional y la matriz de responsabilidades que alinea a tus equipos para escalar la operación sin perder el control ni la velocidad.
            </motion.p>
            ...
            >
              ...
              >
                Calcula tu Salud Organizacional ↓
              </a>
            </motion.div>
            ...
            >
              <span>30 minutos · Sin costo · Evaluación de salud e indicadores organizacionales</span>
            </motion.div>
          </div>
              ...
              {sintomas.map((s) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left flex items-center gap-4 py-4 transition-all duration-200 border-b border-neutral-100 last:border-b-0 ${isChecked ? 'opacity-100' : 'opacity-60 hover:opacity-90'
                      }`}
                  >
                    <div className={`w-5 h-5 rounded border-2 flex items-center justify-center shrink-0 transition-all duration-200 ${isChecked ? 'bg-trebol border-trebol' : 'border-neutral-300'
                      }`}>
                      {isChecked && <CheckCircle2 size={12} className="text-white" />}
                    </div>
                    <span className={`text-sm md:text-base leading-relaxed flex-1 transition-colors duration-200 ${isChecked ? 'text-carbon font-medium' : 'text-carbon/60'
                      }`}>
                      {s.texto}
                    </span>
                  </button>
